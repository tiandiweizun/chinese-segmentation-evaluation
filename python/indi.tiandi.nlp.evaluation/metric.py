...
def get_ner_fmeasure(golden_lists, predict_lists, label_type="BMES"):
    ...
    return accuracy, precision, recall, f_measure, right_num, golden_num, predict_num
...
if __name__ == '__main__':
    ...
    gold = [["B-Null", "M-Null"]]
    predict = [["B-Null", "M-Null", "E-Null", "S-Null"]]
    print(get_ner_fmeasure(gold, predict))

    # sys.argv.append("result")
    # if len(sys.argv) == 3:
